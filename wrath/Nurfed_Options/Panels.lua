  ...
  -- Units Panel
	{
		...
		menu = {
			...
			check20 = {
				template = "nrf_check",
				Anchor = { "TOPLEFT", "$parenteditbox4", "BOTTOMLEFT", 0, -5 },
				vars = { text = L["One Line Debuffs"], option = "onelinedebuffs", page = 2, },
			},
			check21 = {
				template = "nrf_check",
				Point = { "TOPLEFT", "$parentcheck20", "BOTTOMLEFT", 0, -5 },
				vars = { text = L["Big Debuffs"], option = "usebigdebuffs", page = 2, hint = L["Toggle enlarging your debuffs versus others"], },
			},
			slider23 = {
				template = "nrf_slider",
				Point = { "TOPLEFT", "$parentslider2", "BOTTOMLEFT", 0, -40 },
				vars = {
